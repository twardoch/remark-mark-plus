...
exports.markToMarkdown = exports.markFromMarkdown = void 0;
var _micromarkSyntax = require("./micromark-syntax.js");
/**
 * @fileoverview
...
// Our custom token type names

/**
 * Extension for `mdast-util-from-markdown` to handle mark tokens.
 * @type {import('mdast-util-from-markdown').Extension}
 */
const markFromMarkdown = exports.markFromMarkdown = {
  enter: {
    [_micromarkSyntax.types.mark](token) {
      this.enter({
        type: 'mark',
        children: []
      }, token);
 ...
 */
const markToMarkdown = exports.markToMarkdown = {
